# Generated by Powerlevel10k configuration wizard on 2024-11-17 at 00:52 AST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 01704.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='󰢚 '
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n@%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='󰢚 '
